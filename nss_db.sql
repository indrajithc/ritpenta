...
CREATE TABLE IF NOT EXISTS `nss_bg_reqst` (
...
CREATE TABLE IF NOT EXISTS `nss_camp_cordntrs` (
...
CREATE TABLE IF NOT EXISTS `nss_camp_partcptn` (
...
CREATE TABLE IF NOT EXISTS `nss_camp_photo` (
  `cp_pht_slno` int(11) NOT NULL,
  `cp_pht_id` int(15) NOT NULL,
  `cp_pht1` blob NOT NULL,
  `cp_pht2` blob NOT NULL,
  `cp_pht3` blob NOT NULL,
  `cp_pht4` blob NOT NULL,
  `cp_pht5` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `nss_camp_reg` (
...
CREATE TABLE IF NOT EXISTS `nss_event_partcptn` (
...
CREATE TABLE IF NOT EXISTS `nss_event_photo` (
  `evt_pht_slno` int(11) NOT NULL,
  `evt_pht_id` int(15) NOT NULL,
  `evt_pht1` blob NOT NULL,
  `evt_pht2` blob NOT NULL,
  `evt_pht3` blob NOT NULL,
  `evt_pht4` blob NOT NULL,
  `evt_pht5` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `nss_event_reg` (
...
INSERT INTO `nss_event_reg` (`event_id`, `event_name`, `event_date`, `event_hrs`, `event_dtls`, `event_status`) VALUES
(3, 'adsghj', '2018-10-24', '16:00:00', 'gdsdghjgdfghjmgfd', ''),
(4, 'ghhgdghhj', '2018-10-24', '15:00:00', 'ghjkhgfdfghj', '');
...
CREATE TABLE IF NOT EXISTS `nss_eve_cordntrs` (
...
CREATE TABLE IF NOT EXISTS `nss_log` (
...
CREATE TABLE IF NOT EXISTS `nss_vol_reg` (
...
(107, '17MP1079', 'A+', '8281056261', '9567140629', 'indrajithc@hotmail.com');
...
ALTER TABLE `class_details`
  ADD PRIMARY KEY (`classid`), ADD KEY `deptname` (`deptname`), ADD KEY `branch_or_specialisation` (`branch_or_specialisation`), ADD KEY `courseid` (`courseid`);
...
ALTER TABLE `nss_camp_cordntrs`
  ADD PRIMARY KEY (`cmp_slno`), ADD KEY `cmp_cd_id1` (`cmp_cd_id1`), ADD KEY `cmp_cd_id2` (`cmp_cd_id2`), ADD KEY `cmp_id` (`cmp_id`), ADD KEY `cmp_cd_id1_2` (`cmp_cd_id1`), ADD KEY `cmp_cd_id2_2` (`cmp_cd_id2`), ADD KEY `cmp_cd_id2_3` (`cmp_cd_id2`), ADD KEY `cmp_cd_id1_3` (`cmp_cd_id1`), ADD KEY `cmp_id_2` (`cmp_id`);

--
-- Indexes for table `nss_camp_partcptn`
--
ALTER TABLE `nss_camp_partcptn`
  ADD PRIMARY KEY (`camp_part_id`), ADD KEY `camp_id` (`camp_id`), ADD KEY `camp_vol_id` (`camp_vol_id`);

--
-- Indexes for table `nss_camp_photo`
--
ALTER TABLE `nss_camp_photo`
  ADD PRIMARY KEY (`cp_pht_slno`), ADD KEY `cp_pht_id` (`cp_pht_id`);
...
ALTER TABLE `nss_event_partcptn`
  ADD PRIMARY KEY (`evt_part_id`), ADD KEY `evt_id` (`evt_id`), ADD KEY `evt_vol_id` (`evt_vol_id`);

--
-- Indexes for table `nss_event_photo`
--
ALTER TABLE `nss_event_photo`
  ADD PRIMARY KEY (`evt_pht_slno`), ADD KEY `evt_pht_id` (`evt_pht_id`);
...
ALTER TABLE `nss_eve_cordntrs`
  ADD PRIMARY KEY (`eve_slno`), ADD KEY `eve_id` (`eve_id`), ADD KEY `eve_cd_id1` (`eve_cd_id1`), ADD KEY `eve_cd_id2` (`eve_cd_id2`), ADD KEY `eve_cd_id1_2` (`eve_cd_id1`), ADD KEY `eve_cd_id2_2` (`eve_cd_id2`);
...
ALTER TABLE `nss_vol_reg`
  ADD PRIMARY KEY (`vol_id`), ADD KEY `admnno` (`admnno`), ADD KEY `admnno_2` (`admnno`);

--
-- Indexes for table `stud_details`
--
ALTER TABLE `stud_details`
  ADD PRIMARY KEY (`admissionno`), ADD UNIQUE KEY `adm_no` (`admissionno`), ADD KEY `admissionno` (`admissionno`);
...
--
ALTER TABLE `nss_camp_cordntrs`
  MODIFY `cmp_slno` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nss_camp_partcptn`
--
ALTER TABLE `nss_camp_partcptn`
  MODIFY `camp_part_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nss_camp_photo`
--
ALTER TABLE `nss_camp_photo`
  MODIFY `cp_pht_slno` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `nss_event_partcptn`
  MODIFY `evt_part_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nss_event_photo`
--
ALTER TABLE `nss_event_photo`
  MODIFY `evt_pht_slno` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `nss_event_photo`
ADD CONSTRAINT `nss_event_photo_ibfk_1` FOREIGN KEY (`evt_pht_id`) REFERENCES `nss_event_reg` (`event_id`) ON UPDATE CASCADE;
