...
CREATE TABLE `nss_blood_donation` (
  ...
  `bg_added_by` int(11) DEFAULT NULL,
...
INSERT INTO `nss_blood_donation` (`bd_id`, `bd_admno`, `bd_group`, `bd_email`, `bd_mobile`, `bd_quantity`, `bg_added_by`, `bd_date`) VALUES
(1, '16MP646', 'A+', 'sruthysureshvaarnatt@gmail.com', 8943955987, 300, 3, '2018-11-17 17:36:12'),
(2, '16MP646', 'A+', 'sruthysureshvaarnatt@gmail.com', 8943955987, 300, 3, '2018-11-17 17:36:58'),
(3, '16MP646', 'A+', 'sruthysureshvaarnatt@gmail.com', 8943955987, 300, 3, '2018-11-17 17:40:04'),
(4, '16MP646', 'A+', 'sruthysureshvaarnatt@gmail.com', 8943955987, 300, 3, '2018-11-17 17:40:58'),
(5, '16MP645', 'A+', 'salahumuba@gmail.com', 9567875228, 300, 3, '2018-11-17 17:42:03');
...
ALTER TABLE `nss_blood_donation`
  ...
  ADD KEY `bg_added_by` (`bg_added_by`);
...
--
ALTER TABLE `nss_event_partcptn`
  MODIFY `evt_part_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `nss_event_photo`
--
ALTER TABLE `nss_event_photo`
  MODIFY `ev_pht_slno` int(11) NOT NULL AUTO_INCREMENT;
