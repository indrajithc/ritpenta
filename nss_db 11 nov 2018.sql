...
--
-- Host: localhost
-- Generation Time: Nov 11, 2018 at 04:26 PM
...
('', 'vsecretary', 'eqrjbj', '0000-00-00'),
('admin@penta.com', 'admin', 'qwerty', '2018-10-07'),
('indrajithc@hotmail.com', 'vsecretary', 'lfmlfz', '0000-00-00');
...
--
ALTER TABLE `nss_eve_cordntrs`
  MODIFY `eve_slno` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
