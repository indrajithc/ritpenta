...
(3, 'EVE_2018_6941', 'event anema', '2018-11-06', '07:33:00', '2018-11-6 7:30 PM updated ', '', 0, '2018-11-11 14:00:51');
...
(1, 'name now', 'email@eami.com', 'now to do something to do is this is the great ', 1, '2018-11-12 15:26:08'),
(2, 'soem', 'new@ww', 'hello now', 0, '2018-11-12 17:33:19'),
(3, 'soem', 'new@ww', 'hello now', 0, '2018-11-12 17:34:35'),
...
(8, 12567972018, '17MP1079', 'A-', '8281056261', '556655665', 'indrajithc@hotmail.com');
...
--
ALTER TABLE `nss_camp_cordntrs`
  MODIFY `cmp_slno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `nss_eve_cordntrs`
  MODIFY `eve_slno` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `nss_vol_reg`
  MODIFY `vol_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
